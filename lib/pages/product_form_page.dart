...
import 'package:shop/components/image_input.dart';
...
class _ProductFormPageState extends State<ProductFormPage> {
  ...
  void initState() {
    super.initState();
    _fotoFocus.addListener(updateImage);
  ...
  void dispose() {
    ...
    _fotoFocus.removeListener(updateImage);
    _fotoFocus.dispose();
                    ...
                    TextFormField(
                      ...
                      validator: (_quantidade) {
                        ...
                        if (quantidade.trim().length < 0) {
                          return 'Quantidade precisa ser informada.';
                        }
                        return null;
                      },
                    ),
